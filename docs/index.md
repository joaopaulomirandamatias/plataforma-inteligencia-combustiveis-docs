...
| Eng. de dados | [modelo bitemporal](dados/modelo-bitemporal.md) → [catálogo de fontes](dados/catalogo-fontes.md) → [Inmetro: público × restrito](dados/fontes-inmetro.md) → [mapa de integrações](dados/mapa-de-integracoes.md) → [entity resolution](dados/entity-resolution.md) → catálogo de eventos ([plano diretor §3.1](arquitetura/plano-diretor.md)) | 1ª semana |
